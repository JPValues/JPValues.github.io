$(document).ready(() => {
    ...
    let econ_arr = ["共産主義", "社会主義", "やや平等派", "中立", "やや市場派", "資本主義", "自由放任主義"]
    let govt_arr = ["無政府主義", "資本主義的自由意志主義", "やや自由派", "中立", "やや専制派", "権威主義", "極権主義"]
    let scty_arr = ["革新派", "進歩派", "漸進的進歩派", "中立", "やや守旧派", "伝統派", "反動派"]
    let envo_arr = ["超環境保護主義", "環境保護主義", "環境保護優先", "中立", "発展優先", "発展主義", "環境保護懐疑主義"]
